...
const FINGERPRINTS: Fingerprint[] = [
  ...
  },
  {
    ...
    name: "Criteo",
    category: "advertising",
    patterns: [/static\.criteo\.net/i],
    weakPatterns: [/criteo\.com/i, /criteo_q/i],
  },
  {
    id: "taboola",
    name: "Taboola",
  ...
  },
  {
    ...
    name: "Outbrain",
    category: "advertising",
    patterns: [/widgets\.outbrain\.com/i],
    weakPatterns: [/outbrain\.com/i, /OB_platform/i],
  },
  {
    id: "bing_uet",
  ...
  },
  {
    ...
    weakPatterns: [/tawk\.to/i, /Tawk_API/i],
  },
  {
    id: "crisp",
    name: "Crisp",
    category: "chat",
    patterns: [/client\.crisp\.chat/i],
    weakPatterns: [/crisp\.chat/i, /\$crisp/i],
  },
  {
    id: "livechat",
    name: "LiveChat",
    ...
    weakPatterns: [/livechatinc\.com/i, /LiveChatWidget/i],
  },
  {
    id: "optimizely",
    name: "Optimizely",
    ...
    weakPatterns: [/optimizely\.com/i, /optimizely\.push/i],
  },
  {
    id: "vwo",
    name: "VWO",
    category: "analytics",
    patterns: [/dev\.visualwebsiteoptimizer\.com/i],
    weakPatterns: [/visualwebsiteoptimizer\.com/i, /_vwo_/i],
  },
  {
    id: "youtube",
    name: "YouTube Embed",
