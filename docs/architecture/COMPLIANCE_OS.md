...
- **P3 Scanner:** `scans`, `scan_findings` (URL, detected tools, violations, score, timestamp).
...
| 3 | Scanner | URL crawler (Playwright), tool/violation detection, scoring, `scans` | AI provider key; headless-browser runtime |
