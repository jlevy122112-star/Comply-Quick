...
```
            ...
            │  api-response · stripe client · Sentry (instrumentation)                      │
            └───────────────────────────────────────────────────────────────────────────────┘
```
...
to Sentry, and logs revenue events on `charge.failed` /
...
upload on deploy), `LOG_LEVEL`. Sentry is inert when its var is unset.
