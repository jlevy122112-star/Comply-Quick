...
```mermaid
%%{init:{'theme':'base','themeVariables':{'background':'#060810','primaryColor':'#0c1a30','primaryTextColor':'#94a3b8','primaryBorderColor':'#1e3a5f','lineColor':'#334155','secondaryColor':'#080f1a','clusterBkg':'#070b18','clusterBorder':'#1e3a5f','fontFamily':'monospace','edgeLabelBackground':'#060810'}}}%%
graph LR
  classDef tbl fill:#0c1a30,stroke:#334155,color:#7dd3fc,rx:4
  classDef route fill:#0a180a,stroke:#166534,color:#4ade80,rx:3
  classDef action fill:#1a0e00,stroke:#92400e,color:#fbbf24,rx:3
  empty["(No data)"]
```
